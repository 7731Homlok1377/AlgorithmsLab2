...
namespace HanoiTowers
{
    public partial class Form1 : Form
    {
        ...
        private void SolveFor(int diskSize)
        {
            ...
            {
                lstHamleler.Items.Add("Step №" + i + "      " + m.poleFrom + " ===> " + m.poleTo);
                i++;
            }
        ...
        private void btnYeni_Click(object sender, EventArgs e)
        {
            ...
            int n;
            if (!int.TryParse(input, out n)||input=="")//More than 15 is solveable. But the button heights arent responsible. So it doesnt fit in the screen :)
            {
                MessageBox.Show("Enter the number of rings");
                txtDurum.Text = "Enter the number of rings";
            }
            else {
        ...
        private static DialogResult ShowInputDialog(ref string input)
        {
            ...
            //Label inputBox = new Label();

            //inputBox.FormBorderStyle = System.Windows.Forms.FormBorderStyle.FixedToolWindow;
            inputBox.Location = new System.Drawing.Point(-20, 30);
            inputBox.ClientSize = size;
            inputBox.Text = "Enter number";
        ...
        private void moveButton(Button toMove, int PoleIndex)
        {
            ...
            {
                case 1:
                    endPoint= new Point(150 + ((200 - toMove.Size.Width) / 2), 470 - ((Pole1.Count()) * 30));
                    break;
                case 2:
                    endPoint = new Point(330 + ((200 - toMove.Size.Width) / 2), 470 - ((Pole2.Count()) * 30));
                    break;
                case 3:
                    endPoint = new Point(495 + ((200 - toMove.Size.Width) / 2), 470 - ((Pole3.Count()) * 30));
                    break;
                default:
                    break;
            }
